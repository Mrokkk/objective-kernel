...
logger::line_wrapper::line_wrapper(logger& logger)
        : logger_(logger) {
}
...
const char* log_level_to_string(const logger::log_level l) {
    switch (l) {
...
logger::line_wrapper logger::operator<<(const log_level l) {
    char buffer[128];
